...
- **{FormId}**
25-character alphanumeric string found at the end of the URL for the form or at the start of the file name of the API key. For example: `clzvj8fzb00226o90r2b7l1gt`.
- **{SubmissionName}**
11-character alphanumeric including dashes, sometimes also called the SubmissionID in the GC Forms app. For example: `e02-08-d732`.
- **{ConfirmationCode}**
36-character alphanumeric string that includes dashes, sometimes also called the Receipt code in the GC Forms app. For example: `620b203c-9836-4000-bf30-1c3bcc26b834`.
...
<tr>
  ...
  <td><b>Example message</b></td>
  <td><b>Meaning or how to fix</b></td>
</tr>
<tr>
  <td>200</td>
  <td>
...
```
  ...
  <td>List of new submission names successfully retrieved.</td>
</tr>
</table>
...
```
  ...
  <td>Encrypted data of the submission successfully retrieved.</td>
</tr>
<tr>
  <td>404</td>
  <td>
...
```
  ...
  <td>"Form ID" and/or "Submission name" are incorrect or cannot be found.</td>
</tr>
</table>
...
```
  ...
  <td>Submission has already been successfully confirmed.</td>
</tr>
<tr>
  <td>400</td>
  <td>
...
```
  ...
  <td>Provided confirmation code is not the one associated with the submission to be confirmed.</td>
</tr>
<tr>
  <td>404</td>
  <td>
...
```
  ...
  <td>Submission has already been successfully reported as having a problem.</td>
</tr>
<tr>
  <td>400</td>
  <td>
...
```
  ...
  <td>Details about why the provided payload is invalid.</td>
</tr>
<tr>
  <td>400</td>
  <td>
...
```
  ...
  <td>“Form ID” and/or “Submission name” are incorrect or could not be found.</td>
</tr>
</table>
...
```
  ...
  <td>“Form ID” is incorrect or could not be found.</td>
</tr>
</table>
